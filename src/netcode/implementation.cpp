...
int              ncGetRemoteObjectCount (const NCpeer * peer)                                   { return peer->GetViewCount(); }
const NCobject * ncGetRemoteObject      (const NCpeer * peer, int index)                        { return peer->GetView(index); }
